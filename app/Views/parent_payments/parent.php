<?= $this->extend('layouts/publics/apps') ?>

<?php $this->setVar('title', 'Pembayaran Bulanan'); ?>
...
<div class="row">
    <div class="col-md-6 offset-md-3">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= base_url('parent-payments/parent-store') ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field() ?>
